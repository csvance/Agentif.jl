...
# JULIA_SSL_NO_VERIFY_HOSTS="**" julia --project=Claw -t4 Claw/examples/smoke_test_2.jl

using Mattermost, Claw, SQLite
...
println("\nSessions:")
for r in SQLite.DBInterface.execute(assistant.db, "SELECT session_key, session_id FROM claw_sessions")
